...
When(/^the user is able to update Group Description, Division, Department in RMS$/) do
  ...
  differentiators_diff.create_diff_group(@new_id, YML_DATA['diffgroup_name'], YML_DATA['type_1'], YML_DATA['division'], YML_DATA['dept'])
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.create_diff_group_detail(YML_DATA['dgd_sequence-1'], YML_DATA['dgd_detail_1'])
  shared.save_and_close
  differentiators_diff.open_diff_groups
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.edit_diff_group(YML_DATA['dg_change_name'], YML_DATA['division'], YML_DATA['dept'])
  shared.save_and_close
end
Then(/^the record is update to the Diff Group table and RMS DB$/) do
  differentiators_diff.open_diff_groups
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.verify_diff_group(expected_values:YML_DATA['dg_change_name'])
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_group_table(@new_id, YML_DATA['dg_change_name'], YML_DATA['type_1'])
  database.disconnect_db
  differentiators_diff.delete_diff_group
  login_page.logout_to_rms
end
...
When(/^a user delete a the Diff Groups$/) do
  ...
  differentiators_diff.create_diff_group(@new_id, YML_DATA['diffgroup_name'], YML_DATA['type_1'], YML_DATA['division'], YML_DATA['dept'])
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.create_diff_group_detail(YML_DATA['dgd_sequence-1'], YML_DATA['dgd_detail_2'])
...
Then(/^a record is created to the Group Detail window and RMS DB$/) do
  differentiators_diff.open_diff_groups
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.select_diff_group_detail(YML_DATA['dgd_sequence-1'])
  differentiators_diff.verify_diff_group_detail(expected_values:'M Medium')
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_group_detail_table(@new_id, YML_DATA['dgd_detail_2'], YML_DATA['dgd_sequence-1'])
  database.disconnect_db
  differentiators_diff.delete_diff_group
  login_page.logout_to_rms
end
...
When(/^a user update the Sequence in the Group Detail table$/) do
  ...
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.select_diff_group_detail(YML_DATA['dgd_sequence-1'])
  differentiators_diff.edit_diff_group_detail(YML_DATA['dgd_sequence-2'])
  shared.save_and_close
...
Then(/^the record is update to the Group Detail window and RMS DB$/) do
  differentiators_diff.open_diff_groups
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.select_diff_group_detail(YML_DATA['dgd_sequence-2'])
  differentiators_diff.verify_diff_group_detail(expected_values:'M Medium')
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_group_detail_table(@new_id, YML_DATA['dgd_detail_2'], YML_DATA['dgd_sequence-2'])
  database.disconnect_db
  differentiators_diff.delete_diff_group
  login_page.logout_to_rms
end
...
When(/^a user delete a Group Details$/) do
  ...
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.create_diff_group_detail(YML_DATA['dgd_sequence-1'], YML_DATA['dgd_detail_1'])
  differentiators_diff.create_diff_group_detail(YML_DATA['dgd_sequence-2'], YML_DATA['dgd_detail_2'])
  differentiators_diff.create_diff_group_detail(YML_DATA['dgd_sequence-3'], YML_DATA['dgd_detail_3'])
  shared.save_and_close
  differentiators_diff.open_diff_groups
  differentiators_diff.select_diff_group(@new_id)
  differentiators_diff.select_diff_group_detail(YML_DATA['dgd_sequence-1'])
...
Then(/^the record is delete on the Diff Group table and RMS DB$/) do
  ...
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_delete_diff_group_detail_table(@new_id, YML_DATA['dgd_sequence-1'])
  database.disconnect_db
  login_page.logout_to_rms
end
...
When(/^user enters the Range, Range Type and selects a Diff Type and Group for Diff types 1-3$/) do
  ...
  database.disconnect_db
  differentiators_diff.create_diff_range(@new_id, YML_DATA['diff_range_desc'], YML_DATA['type_1'], YML_DATA['dr_group_1'],
                                         YML_DATA['type_2'], YML_DATA['dr_group_2'])
  differentiators_diff.create_diff_range_detail(YML_DATA['colour_1'], YML_DATA['size_1'], YML_DATA['ratio'])
  shared.save_and_close
end
...
Then(/^the Diff Range Header record is created in RMS and RMS DB$/) do
  ...
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_range_header_table(@new_id, YML_DATA['diff_range_desc'], YML_DATA['dr_group_1'], YML_DATA['dr_group_2'], 'R' )
  database.disconnect_db
...
Then(/^the Diff Range Detail record is created in RMS and RMS DB$/) do
  ...
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_range_detail_table(@new_id, YML_DATA['size_1'], YML_DATA['colour_1'], '100.0', YML_DATA['ratio'])
  database.disconnect_db
  differentiators_diff.delete_diff_range
  login_page.logout_to_rms
end
...
Given(/^a user is in Manage Diff Range screen$/) do
  ...
  differentiators_diff.create_diff_range(@new_id,YML_DATA['diff_range_desc'], YML_DATA['type_1'], YML_DATA['dr_group_1'],
                                         YML_DATA['type_2'], YML_DATA['dr_group_2'])
  differentiators_diff.create_diff_range_detail(YML_DATA['colour_1'], YML_DATA['size_1'],YML_DATA['ratio'])
  differentiators_diff.create_diff_range_detail(YML_DATA['colour_2'], YML_DATA['size_2'],YML_DATA['ratio'])
  shared.save_and_close
  differentiators_diff.open_manage_diff_range
  differentiators_diff.select_diff_range(@new_id)
end
...
When(/^user enters the Diff Range details to a existent Range Header$/) do
  differentiators_diff.create_diff_range_detail(YML_DATA['colour_3'], YML_DATA['size_3'],YML_DATA['ratio'])
  shared.save_and_close
end
...
Then(/^the Diff Range details is created in RMS and RMS DB$/) do
  ...
  differentiators_diff.verify_diff_range(expected_values:'KNG King BLACK Black 100')
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_range_detail_table(@new_id, YML_DATA['size_1'], YML_DATA['colour_1'], YML_DATA['ratio'])
  database.disconnect_db
  differentiators_diff.delete_diff_range
  login_page.logout_to_rms
end
...
When(/^user updates the Diff Range Detail$/) do
  ...
  differentiators_diff.edit_diff_range_detail(YML_DATA['colour_2'], YML_DATA['size_2'],YML_DATA['ratio'])
...
Then(/^the Diff Range Detail is updated in RMS and RMS DB$/) do
  ...
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_range_detail_table(@new_id, YML_DATA['size_2'], YML_DATA['colour_2'], YML_DATA['ratio'])
  database.disconnect_db
  differentiators_diff.delete_diff_range
  login_page.logout_to_rms
end
...
When(/^user enters the relevant Merchandise details, Sub-Department, Category, Sub-Category$/) do
  ...
  differentiators_diff.create_diff_ratio(YML_DATA['diff_ratio_desc'], YML_DATA['subdpt'], YML_DATA['category'], YML_DATA['subcategory'], YML_DATA['Test_Group_colour'],
                                          YML_DATA['Test_Group_Compatibility'], YML_DATA['Test_Diff_Group_Flavour'], YML_DATA['review_2'])
  shared.save_and_close
end
...
Then(/^the Diff Ratio is created in RMS and RMS DB$/) do
  ...
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_ratio_table(@new_id, YML_DATA['diff_ratio_desc'], YML_DATA['department'], YML_DATA['class'], YML_DATA['subclass'], YML_DATA['Test_Group_colour'],
                                   YML_DATA['Test_Group_Compatibility'], YML_DATA['Test_Diff_Group_Flavour'], YML_DATA['review_2'])
  database.disconnect_db
...
Then(/^user can create a new Ratio by entering Ratio Description and Merchandise Hierarchy details$/) do
  ...
  @new_id = differentiators_diff.diff_ratio_id
  differentiators_diff.create_diff_ratio(YML_DATA['diff_ratio_desc'], YML_DATA['department'], YML_DATA['class'], YML_DATA['subclass2'],
                                         YML_DATA['Test_Group_colour'], YML_DATA['Test_Group_Compatibility'], YML_DATA['Test_Diff_Group_Flavour'], YML_DATA['review_2'])
  shared.save_and_close
  differentiators_diff.search_diff_ratio(@new_id)
  differentiators_diff.verify_diff_ratio(expected_values:'New Diff Ratio 44 Test Department 1 Test Class 2 Test Subclass')
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_ratio_table(@new_id, YML_DATA['diff_ratio_desc'], YML_DATA['department'], YML_DATA['class'], YML_DATA['subclass2'],
                                   YML_DATA['Test_Group_colour'], YML_DATA['Test_Group_Compatibility'], YML_DATA['Test_Diff_Group_Flavour'], YML_DATA['review_2'])
  database.disconnect_db
  differentiators_diff.delete_diff_ratio
  login_page.logout_to_rms
...
Then(/^user amend the Ratio Description and Merchandise Hierarchy details$/) do
  differentiators_diff.add_diff_ratio
  @new_id = differentiators_diff.diff_ratio_id
  differentiators_diff.create_diff_ratio(YML_DATA['diff_ratio_desc'], YML_DATA['department'], YML_DATA['class'], YML_DATA['subclass3'],
                                         YML_DATA['Test_Group_colour'], YML_DATA['Test_Group_Compatibility'], YML_DATA['Test_Diff_Group_Flavour'], YML_DATA['review_2'])
  shared.save_and_close
end
...
Then(/^the Diff Ratio will be updated in RMS DB$/) do
  differentiators_diff.search_diff_ratio(@new_id)
  differentiators_diff.edit_diff_ratio(YML_DATA['diff_ratio_change_desc'], YML_DATA['review_3'], '9/20/19')
  differentiators_diff.search_diff_ratio(@new_id)
  database.connect_to_db('db_hostname', 'db_port', 'db_servicename', 'db_username', 'db_password')
  database.verify_diff_ratio_table(@new_id, YML_DATA['diff_ratio_change_desc'], YML_DATA['department'], YML_DATA['class'], YML_DATA['subclass'], YML_DATA['Test_Group_colour'],
                                   YML_DATA['Test_Group_Compatibility'], YML_DATA['Test_Diff_Group_Flavour'], YML_DATA['review_3'])
  database.disconnect_db
